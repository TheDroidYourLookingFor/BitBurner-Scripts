...
function makeElementsMinimisable(doc) {
	[].slice.call(
		doc.querySelectorAll('.MuiPaper-root.MuiPaper-elevation.MuiPaper-rounded.react-draggable div > .MuiPaper-root.MuiPaper-elevation.MuiPaper-rounded.MuiPaper-elevation1:not([data-can-be-minimised]):first-child')
